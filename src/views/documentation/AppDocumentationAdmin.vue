    ...
    <div class="app-documentation-admin">
      ...
      <el-card class="toolbar-card">
        <div class="search-bar">
          ...
          />
          <el-select 
            v-model="search.documentationType" 
            placeholder="请选择分类" 
            clearable
            style="width: 150px"
          >
          ...
          <el-date-picker
            ...
            type="daterange"
            start-placeholder="计划发布时间起"
            end-placeholder="计划发布时间止"
          ...
          <el-date-picker
            ...
            type="daterange"
            start-placeholder="实际发布时间起"
            end-placeholder="实际发布时间止"
            value-format="yyyy-MM-dd"
            clearable
          />
      ...
      <el-dialog :title="isEdit ? '编辑资料' : '新增资料'" :visible.sync="dialogVisible" width="600px">
        <el-form :model="form" label-width="100px">
          ...
          <el-form-item label="链接">
            <el-input v-model="form.url" placeholder="请输入资料链接" />
          </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      submitForm() {
        ...
        service.post(url, {
          ...this.form,
          planReleaseTime: this.form.planReleaseTime,
